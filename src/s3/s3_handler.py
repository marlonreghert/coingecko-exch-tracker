...
class S3Handler:
    def __init__(self, bucket_name, endpoint_url, aws_access_key_id, aws_secret_access_key, region_name="us-east-1"):
        ...
        self.logger.info(f"Creating S3Handler with:  bucket_name:{bucket_name}, aws_access_key_id:{aws_access_key_id}, aws_secret_access_key:{aws_secret_access_key}, region_name:{region_name}")
